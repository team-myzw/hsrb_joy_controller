...
class HandGrip(object):
    def __init__(self):
        ...
        rospy.set_param('/hsrb/omni_base_controller/base_coordinates', ["odom_x", "odom_y","odom_t"])
        self.action_server = actionlib.SimpleActionServer("/hsrb/omni_base_controller/follow_joint_trajectory", 
                                                    FollowJointTrajectoryAction, execute_cb=self.cb,
                                                    auto_start=False)

        self.grip_act = rospy.Publisher("/hsrb/omni_base_controller/command",JointTrajectory,queue_size=10)
    ...
    def cb(self, data):
        ...
        joint.joint_names =["odom_x", "odom_y","odom_t"]
...
if __name__ == "__main__":
    rospy.init_node("omni_state_controller")
