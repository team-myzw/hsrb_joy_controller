...
class HandGrip(object):
    def __init__(self):
        ...
        rospy.set_param('/hsrb/head_trajectory_controller/joints', ["head_pan_joint", "head_tilt_joint"])
        self.action_server = actionlib.SimpleActionServer("/hsrb/head_trajectory_controller/follow_joint_trajectory", 
                                                    FollowJointTrajectoryAction, execute_cb=self.cb,
                                                    auto_start=False)
        self.grip_act = rospy.Publisher("/hsrb/head_trajectory_controller/command",JointTrajectory,queue_size=10)
    ...
    def cb(self, data):
        ...
        joint.joint_names = ["head_pan_joint", "head_tilt_joint"]
...
if __name__ == "__main__":
    rospy.init_node("head_state_controller")
